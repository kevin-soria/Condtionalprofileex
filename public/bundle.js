...
function render(variables = {}) {
  ...
  if (variables.city === "Miami") document.querySelector("#addCountry").innerHTML = "<option value='USA'>USA</option>";
  if (variables.city === "Miami") document.querySelector("#test").innerHTML = "hello you ha ha ha a";
